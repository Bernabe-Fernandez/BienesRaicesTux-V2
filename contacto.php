...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (strlen($mensaje) < 30) {
        $errores[] = 'El mensaje es Obligatorio y debe tener al menos 30 caracteres';
    }
    if (!$ocupacion) {
    ...
    <form method="POST" class="formulario" action="contacto.php" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <div class="forma-contacto">
                ...
                <input type="radio" id="tipoContacto" name="contacto" value="1">
                <label for="contactar-correo">correo</label>
                <input type="radio" id="tipoContacto" name="contacto" value="2">
            </div>
